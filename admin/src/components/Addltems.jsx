              ...
              <div className={styles.gridTwoCols}>
                <div>
                  ...
                  >
                    ...
                    {categories.map((c) => (
                      <option value={c} key={c} className=" bg-[#3a2b2b]">
                        {c}
                      </option>
                    ))}
                  </select>
                ...
                <div>
                  ...
                  <div className=" flex items-center gap-3 sm:gap-4">
                    <button
                      ...
                      className=" text-2xl sm:text-3xl text-amber-400 hover:text-amber-300 transition-transform animate-pulse"
                    >
                      <FiHeart />
                    </button>
                    <input
