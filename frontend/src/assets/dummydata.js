...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.facebook.com/virendra.dangi.1485', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/shyam_premi_virendra_dangi/', color: '#E1306C', label: 'Instagram' },
    // { icon: FaXTwitter, link: 'https://x.com/HexagonDService?t=Vv5ReZAIbXONqkq_O0ksWQ&s=09', color: '#000', label: 'X' },
    { icon: FaYoutube, link: 'https://www.youtube.com/channel/UCd6vp5mpRFGRI79IQUJsYZw', color: '#FF0000', label: 'Youtube' },
];
