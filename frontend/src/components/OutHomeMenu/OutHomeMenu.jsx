  ...
  px-4 sm:px-6 lg:px-8 "
    >
      <div className="max-w-7xl mx-auto">
        ...
        mb-12 bg-clip-text text-transparent  bg-gradient-to-r from-amber-200 via-amber-300 to-amber-200"
        >
              ...
              >
                ...
                <div className=" p-4 sm:p-6 flex flex-col flex-grow">
                  <div
                    ...
                    bg-gradient-to-r from-transparent  via-amber-800/50 to-transparent opacity-50 transition-all duration-300 "
                  />
                  ...
                  <div className=" mt-auto flex items-center gap-4 justify-center">
                    <div className=" bg-amber-100/10 backdrop-bulr-sm px-3 py-1 rounded-2xl shadow-lg">
                    ...
                    <div className=" flex items-center gap-2">
                      {qty > 0 ? (
                        ...
                        <button
                          ...
                          className=" bg-amber-900/40 px-3 sm:px-4 py-1 sm:py-1.5 rounded-md sm:rounded-full
                                 font-cinzel text-xs sm:text-sm uppercase tracking-wider
                                  transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-amber-900/20
                                relative overflow-hidden border border-amber-800/50 whitespace-nowrap min-w-[100px]"
                          // className=" bg-amber-900/40 px-4 py-1.5 rounded-full
                          //         font-cinzel text-xs uppercase sm:text-sm tracking-wider
                          //         transition-transfrom duration-300 hover:scale-110 hover:shadow-lg hover:shadow-amber-900/20 relative overflow-hidden
