...
import { bannerAssets } from "../../assets/dummydata.js";
const Banner = () => {
  ...
  return (
    <div className="relative">
      <div
        className=" bg-gradient-to-br from-amber-900 via-amber-700 text-white
      ...
      >
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          <div className="flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left">
            <h1 className=" text-4xl sm:text-4xl lg:text-6xl font-bold leading-tight font-serif drop-shadow-md">
              We're Here <br />
            ...
            >
              <div className=" relative flex items-center  bg-amber-900/30 rounded-xl border-2 border-amber-500 shadow-2xl hover:bg-amber-400/50 transition-all duration-300">
                ...
                <button
                  ...
                  rounded-lg font-semibold text-amber-900 hover:from-amber-300 hover:to-amber-200 transition-all
                  duration-300 shadow-lg hover:shadow-amber-300/20"
                >
                  Search
                </button>
              </div>
          ...
          <div className=" flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]">
            {/* Main Image */}
            <div
              className=" relative rounded-full p-1 bg-gradient-to-br from-amber-700 via-amber-800 to-amber-400         
