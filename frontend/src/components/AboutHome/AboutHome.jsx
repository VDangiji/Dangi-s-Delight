...
import { aboutfeature } from "../../assets/dummydata.js";
...
const AboutHome = () => {
  return (
    <div
      className=" min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white
    ...
    blur-3xl mix-blend-soft-light"
      ...
      >
          ...
          <div className=" space-y-4 sm:space-y-8 px-4 sm:px-0">
            <h2 className=" text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">
              ...
              <span className=" inline-block mt-2 sm:mt-4 text-2xl sm:text-3xl md:text-4xl opacity-90 font-light">
                Where Flavor Dance &amp; Memories Bloom
              </span>
            </h2>
        ...
        <div
          className=" w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative
           group transform hover:scale-[1.01] transition-all duration-500"
        >
          <div
            className="relative rounded-[4rem] overflow-hidden border-4 border-amber-4 border-amber-900/30 hover:border-amber-600 transition 
            duration-500 shadow-2xl shadow-black/50"
          >
            <div className=" absolute inset-0 bg-gradient-to-r from-amber-400/15 via-transparent to-amber-600/10 mix-blend-lighten " />
            <img
              src={AboutImage}
              alt="Restaurant"
            ...
            />
            <div className=" absolute -bottom-12 left-1/2 translate-x-1/2 w-4/5 h-16 bg-amber-600/30 blur-3xl
            z-0"/>
          </div>
