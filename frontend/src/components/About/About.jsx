...
const About = () => {
  const [hoveredStat, setHoveredStats] = useState(null);

  return (
    <div
      className=" min-h-screen bg-gradient-to-br form-[#1a120b]
    via-[#3c2a21] to-[#1a120b] text-amber-50 overflow-hidden relative"
    >
      ...
      >
        <div className=" max-w-4xl mx-auto">
          <motion.h1
            ...
            bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-yello-600"
          >
            Culinary Express
          </motion.h1>
          ...
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className=" relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border border-amber-600/30
                 hover:border-amber-500 transition-all duration-300 h-full"
                >
          ...
          {stats.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                onHoverStart={() => setHoveredStats(i)}
          ...
          <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12">
            {teamMembers.map((m, i) => (
              ...
              >
                ...
                border-2 border-amber-600/30 hover:border-amber-500 transition-all duration-500 shadow-2xl
