      ...
      <div className="max-w-7xl mx-auto relative z-10">
              ...
              <div className=" relative">
                ...
                <button
                  ...
                  className=" absolute right-1 top-1 bg-gradient-to-br from-amber-300
                    via-oragne-500 to-amber-600 text-white px-4 py-2 rounded-full
                    flex items-center gap-1.5 hover:shadow-amber-400/30 overflow-hidden transition-all duration-500"
                >
                  ...
                  flex-shrink-0"
                  />
                  <span className=" absolute inset-0 -translate-x-full bg-gradient-to-r form-transparent via-amber-50/30 to-transparent group-hover:translate-x-full transition-transform duration-300" />
                </button>
              </div>
            </form>
          </div>
              ...
              <div className="flex space-x-4">
                {socialIcons.map(({ icon: Icon, link, color, label }, idx) => (
                  ...
                  >
                    ...
                    <span
                      className=" absolute -bottom-8 left-1/2 -translate-x-1/2 bg-amber-400 text-black px-2 py-1 rounded text-xs font-bold opacity-0
        ...
        <div className=" border-t border-amber-800 pt-8 mt-8 text-center">
          <p className=" text-amber-400 text-lg mb-2 font-playfair">
            &copy; 2025 Dangi's Delight . All Rights Reserved.
          </p>
          <div className=" group inline-block">
                 <a href="" className=" text-lg font-sacramento bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 bg-clip-text text-transparent hover:text-purple-300 transition-all duration-500">
                  Designed & Developed by Virendra Dangi
                 </a>
          </div>
        </div>
      </div>
